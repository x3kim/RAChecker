...
const EN: Record<string, string> = {
  ...
  'scan.folderNote': 'This folder is remembered. Scanning only starts when you ask for it — turn on “Scan on launch” in Settings if you want it automatic.',
  'scan.rescanFolder': 'Scan saved folder again',
  ...
  'scan.discNote': 'These disc formats still need the desktop app (e.g. GameCube/Wii, RVZ, GCZ, GDI, CUE/BIN). CHD, ISO, CSO/ZSO and PBP hash on-device.',
  // games
  ...
  // profile · collection
  'prof.colFiles': 'FILES', 'prof.colMatched': 'WITH ACH.', 'prof.colPoints': 'POINTS TO EARN',
  ...
  'ins.files': 'FILES', 'ins.withAch': 'WITH ACH.', 'ins.obtAch': 'ACHIEVEMENTS', 'ins.obtPts': 'POINTS TO EARN',
  ...
  'set.scanning': 'SCANNING & START',
  'set.startTab': 'Screen the app opens on',
  'set.autoScan': 'Scan the saved folder on launch',
  'set.autoScanHelp': 'Off by default: a scan reads every file in the folder, which takes time and battery. Leave it off and start scans yourself from the Scan tab.',
  ...
  'gd.pointsN': '{n} points', 'gd.pointsOf': '{n} of {total} points',
  'gd.filter.all': 'All', 'gd.filter.missable': 'Missable', 'gd.filter.progression': 'Progression',
  'gd.filter.win': 'Win condition', 'gd.filter.earned': 'Unlocked', 'gd.filter.unearned': 'Remaining',
  'gd.filter.none': 'No achievement matches this filter.',
...
const DE: Record<string, string> = {
  ...
  'scan.folderNote': 'Dieser Ordner ist gemerkt. Gescannt wird nur, wenn du es anstößt — für automatisches Scannen „Beim Start scannen" in den Einstellungen einschalten.',
  'scan.rescanFolder': 'Gemerkten Ordner erneut scannen',
  ...
  'scan.discNote': 'Diese Disc-Formate brauchen weiterhin die Desktop-App (z. B. GameCube/Wii, RVZ, GCZ, GDI, CUE/BIN). CHD, ISO, CSO/ZSO und PBP werden auf dem Gerät gehasht.',
  ...
  'prof.colFiles': 'DATEIEN', 'prof.colMatched': 'MIT ERFOLGEN', 'prof.colPoints': 'HOLBARE PUNKTE',
  ...
  'ins.files': 'DATEIEN', 'ins.withAch': 'MIT ERFOLGEN', 'ins.obtAch': 'ERFOLGE', 'ins.obtPts': 'HOLBARE PUNKTE',
  ...
  'set.scanning': 'SCANNEN & START',
  'set.startTab': 'Seite beim Öffnen der App',
  'set.autoScan': 'Gemerkten Ordner beim Start scannen',
  'set.autoScanHelp': 'Standardmäßig aus: ein Scan liest jede Datei im Ordner, das kostet Zeit und Akku. Lass es aus und starte Scans selbst im Scan-Tab.',
  ...
  'gd.pointsN': '{n} Punkte', 'gd.pointsOf': '{n} von {total} Punkten',
  'gd.filter.all': 'Alle', 'gd.filter.missable': 'Verpassbar', 'gd.filter.progression': 'Fortschritt',
  'gd.filter.win': 'Abschluss', 'gd.filter.earned': 'Erhalten', 'gd.filter.unearned': 'Offen',
  'gd.filter.none': 'Kein Erfolg passt zu diesem Filter.',
