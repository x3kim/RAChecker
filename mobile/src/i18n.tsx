...
const EN: Record<string, string> = {
  ...
  'scan.intro': 'Hash your ROMs and disc images on the device and match them against the RetroAchievements database. Nothing leaves your phone — the lookup runs against the list you synced.',
  ...
  'scan.unpacking': 'unpacking {p}% ({mb} MB)',
  'scan.bigArchiveHint': 'Large archives and disc images can take several minutes on a phone — the progress line keeps moving while it works.',
  'scan.withAch': 'with achievements', 'scan.errors': 'errors',
  'scan.rowHashed': 'Hashed ✓ — sync the hash DB to check for achievements',
  'scan.rowNoMatch': 'Not in RetroAchievements — a different dump/version of a game, or a file RA doesn’t track',
  'scan.rowNoSet': '{c} · recognised game, but it has no achievement set yet',
  ...
  'scan.regionTitle': 'Region & language', 'scan.regionSort': 'Preferred first',
  'scan.regionHint': 'Set your preferred region in Settings to sort these files by it.',
  'scan.regionNone': 'No file with that region/language.',
  'scan.regionVerifying': 'Fetching official ROM names from RetroAchievements…',
  'scan.regionSourceHint': 'Solid outline = confirmed by RetroAchievements via the file\'s hash. Dashed = guessed from the filename.',
  ...
  'sync.body': 'Download the RetroAchievements hash list — cartridge and disc systems — so scanning works offline. Runs on demand; pick only the systems you own to make it faster.',
  ...
  'set.regionDesc': 'When a game exists in several versions, which one do you want? The list is applied top to bottom and sorts your scan results. Nothing is hidden or deleted.',
  'set.regionEmpty': 'No order set — lists keep the sorting they had.',
  'set.regionAddRegion': '+ Region', 'set.regionAddLang': '+ Language',
  ...
  'set.regionClear': 'Clear',
  'set.regionNote': 'The region is read from the filename, e.g. "(Japan)", "(J)", "(En,Fr,De)".',
  ...
  'onb.s2body': 'Only sync the systems you own — fewer systems = faster. You can change this later.',
...
const DE: Record<string, string> = {
  ...
  'scan.intro': 'Hasht deine ROMs und Disc-Images direkt auf dem Gerät und gleicht sie mit der RetroAchievements-Datenbank ab. Nichts verlässt dein Handy — abgeglichen wird gegen die synchronisierte Liste.',
  ...
  'scan.unpacking': 'entpackt {p}% ({mb} MB)',
  'scan.bigArchiveHint': 'Große Archive und Disc-Images können am Handy mehrere Minuten dauern — die Fortschrittszeile bewegt sich, solange gearbeitet wird.',
  'scan.withAch': 'mit Erfolgen', 'scan.errors': 'Fehler',
  'scan.rowHashed': 'Gehasht ✓ — synchronisiere die Hash-DB, um Erfolge zu prüfen',
  'scan.rowNoMatch': 'Nicht bei RetroAchievements — ein anderer Dump/eine andere Version, oder eine Datei, die RA nicht führt',
  'scan.rowNoSet': '{c} · Spiel erkannt, hat aber noch kein Achievement-Set',
  ...
  'scan.regionTitle': 'Region & Sprache', 'scan.regionSort': 'Wunsch zuerst',
  'scan.regionHint': 'Wunsch-Region in den Einstellungen setzen, dann wird danach sortiert.',
  'scan.regionNone': 'Keine Datei mit dieser Region/Sprache.',
  'scan.regionVerifying': 'Hole offizielle ROM-Namen von RetroAchievements…',
  'scan.regionSourceHint': 'Durchgezogener Rahmen = von RetroAchievements über den Hash bestätigt. Gestrichelt = aus dem Dateinamen geraten.',
  ...
  'sync.body': 'Lädt die RetroAchievements-Hash-Liste — Cartridge- und Disc-Systeme —, damit das Scannen offline funktioniert. Läuft auf Abruf; wähle nur die Systeme, die du besitzt, dann geht es schneller.',
  ...
  'set.regionDesc': 'Wenn es ein Spiel in mehreren Fassungen gibt, welche willst du? Die Liste wird von oben nach unten abgearbeitet und sortiert deine Scan-Ergebnisse. Es wird nichts ausgeblendet oder gelöscht.',
  'set.regionEmpty': 'Keine Reihenfolge gesetzt — Listen bleiben sortiert wie bisher.',
  'set.regionAddRegion': '+ Region', 'set.regionAddLang': '+ Sprache',
  ...
  'set.regionClear': 'Leeren',
  'set.regionNote': 'Region wird aus dem Dateinamen gelesen, z. B. „(Japan)", „(J)", „(En,Fr,De)".',
  ...
  'onb.s2body': 'Synchronisiere nur die Systeme, die du besitzt — weniger Systeme = schneller. Später änderbar.',
