...
const EN: Record<string, string> = {
  ...
  'scan.archiveUnsupported': '{ext} archives can’t be opened on the phone — extract the ROM first, or use the desktop app. (ZIP works.)',
...
const DE: Record<string, string> = {
  ...
  'scan.archiveUnsupported': '{ext}-Archive lassen sich am Handy nicht öffnen — ROM vorher entpacken oder die Desktop-App nutzen. (ZIP funktioniert.)',
