...
export const MAGIC = {
  ...
  // rcheevos compares 5 bytes here — "LYNX" plus its terminating NUL
  // (hash_rom.c rc_hash_lynx). Matching only "LYNX" would strip the 64-byte
  // header off files that rcheevos leaves alone, producing a different hash.
  LYNX: [0x4c, 0x59, 0x4e, 0x58, 0x00],
